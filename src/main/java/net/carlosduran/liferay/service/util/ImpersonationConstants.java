...
public class ImpersonationConstants {
	...
	public static final int NO_IMPERSONATION = 0;
	public static final int IMPRESONATION_RESULT_DENIED = 2;
	public static final int IMPRESONATION_RESULT_GRANTED = 1;
	public static final int IMPRESONATION_RESULT_USER_UNAVAILABLE = 3;
}
